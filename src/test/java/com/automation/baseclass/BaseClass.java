...
public class BaseClass {
	...
	public void setup(@Optional(myPlatform)String platform, @Optional("chrome_normal")String runOn) throws MalformedURLException
	{
		...
		case "mobile":
			...
			cap.setCapability("app", path+"//App//RecordLabelApp.apk");
			cap.setCapability("platformName", "Android");
			cap.setCapability("deviceName", "Samsung");
			cap.setCapability("appWaitActivity", "org.RecordLabelApp.android.ui.accounts.SignInActivity");
			cap.setCapability("appPackage", "org.RecordLabelApp.android");
